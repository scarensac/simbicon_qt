...
public:
	...
	void init( ObjectiveFunctionType & objectiveFunction, const SearchPointType& startingPoint);
	void init( ObjectiveFunctionType & objectiveFunction, const SearchPointType& startingPoint, double initDelta);
	void init( ObjectiveFunctionType & objectiveFunction, const SearchPointType& startingPoint, const RealVector& initDelta);
	using AbstractSingleObjectiveOptimizer<RealVector >::init;

	void step( ObjectiveFunctionType& objectiveFunction);
