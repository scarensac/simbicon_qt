...
#include <gui/InteractionInterface.h>
...
public:
    ...
    /**
     * @brief apply_perturbation_on_pelvis applys a force on the pelvis
     * @param v
     */
    virtual void apply_perturbation_on_pelvis(Vector3d f) = 0;
    virtual void apply_perturbation(Vector3d perturbation=Vector3d(0,0,0), bool new_perturbation=false) = 0;
