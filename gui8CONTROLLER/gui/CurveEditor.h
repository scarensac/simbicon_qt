...
protected:
    ...
    bool holdMouse;
    // True if the alt key was pressed when clicking
    bool keyPressedAlt;
    ...
    // store the axis concerned by the trajectory (if it is smth special where this value has no mening leave the default value
    Vector3d axis;
...
public:
	...
	*/
    void setTrajectory( Trajectory1D* trajectory, Vector3d input_axis);
